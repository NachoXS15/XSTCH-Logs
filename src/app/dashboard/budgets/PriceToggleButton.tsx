...
export default function PriceToggleButton() {
    ...
    return (
        <button
            ...
            className="fixed bottom-24 md:bottom-6 right-6 z-40 flex items-center gap-2 bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 pl-3 pr-4 py-2.5 rounded-full shadow-lg hover:opacity-90 active:scale-95 transition-all text-sm font-medium"
        >
            {showPrices
