        ...
        <>
            <table className="text-left table-auto min-w-max overflow-hidden w-full">
                <thead className="w-full border-b border-slate-300 ">
                    <tr className='w-full'>
                        <th className="p-4 border-b border-slate-300 bg-slate-50 dark:bg-slate-900">
                        ...
                        clients.map((client, i) => {
                            ...
                            return (
                                ...
                                <tr key={i} className="hover:bg-slate-50 dark:bg-slate-900">
                                    <td className="p-4 border-b border-slate-200 dark:border-slate-500">
                                        <p className="block text-sm text-slate-800 dark:text-white">
                                            {client.client_name}
                                        </p>
                                    </td>
                                    <td className="p-4 border-b border-slate-200 dark:border-slate-500">
                                        <p className="block text-sm leading-6 text-slate-800 dark:text-white max-w-[400px] text-wrap">
                                            {client.service}
                                        </p>
                                    </td>
                                    <td className="p-4 border-b border-slate-200 dark:border-slate-500">
                                    ...
                                    <td className="p-4 w-32 border-b border-slate-200 dark:border-slate-500">
                                        <p className="block text-sm text-slate-800 dark:text-white">
                ...
                <tfoot>
                    <tr className=' w-full '>
                        <td colSpan={2} className="p-4 text-left font-bold text-slate-800 dark:text-white border-t-2 border-slate-300">
                            Total: {totalLogs}
                        </td>
                        <td colSpan={2} className="p-4 font-semibold text-slate-800 dark:text-white border-t border-slate-300">
            ...
            <div className="flex justify-between items-center px-4 py-3">
                ...
                <div className="flex space-x-1">
                    <button className="px-3 py-1 min-w-9 min-h-9 text-sm font-normal text-slate-500 bg-white border border-slate-200 dark:border-slate-500 rounded hover:bg-slate-50 hover:border-slate-400 transition duration-200 ease">
                        {`<`}
                    </button>
