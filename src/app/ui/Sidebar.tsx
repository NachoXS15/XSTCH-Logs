...
export default function Sidebar() {
  ...
  return (
    <>
      {!toggled ? <button className="md:hidden fixed top-5 left-7 mb-10" onClick={() => setToggled(!toggled)}><MenuIcon /></button> : ""}
      <aside className={`bg-slate-100 shadow-sm transition-all relative z-50 ${toggled ? "w-64 lg:w-2/12 px-5 flex" : "w-20 px-10"} flex flex-col justify-between py-10`}>
