...
export default function Header(props) {
    return (
        // <nav className="navbar navbar-expand-lg bg-dark mb-3 rounded d-flex">
        ...
        //         </button>
        //     </div>
        //     <div className="collapse navbar-collapse d-flex jus" id="togglerHeader">
        //         
        //     </div>
        // </nav>
        <>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="navbar-nav ms-auto mb-2 mb-lg-0 text-center d-flex align-items-center">
                            ...
                            <Nav.Link className="text-white" style={{ margin: '0 1.5em 0' }} to="/create" as={NavLink}>
                                <Button >{`Add ${props.create}`}</Button>
                            </Nav.Link>
                        </Nav>
                    </Navbar.Collapse>
                </Container>
